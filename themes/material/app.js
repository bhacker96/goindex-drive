...
function nav(path) {
    ...
    <a href="https://www.blackhatdrive.ga" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Blackhat Drive'}">
...
function list_files(path,files){
    ...
    for(i in files){
        ...
        if(item['mimeType'] == 'application/vnd.google-apps.folder'){
            ...
            var ext = p.split('.').pop();
            if("|html|php|css|go|java|js|json|txt|sh|md|mp4|webm|avi|bmp|jpg|jpeg|png|gif|m4a|mp3|wav|ogg|mpg|mpeg|mkv|eac3|rm|rmvb|mov|wmv|asf|ts|flv|".indexOf(`|${ext}|`) >= 0){
	            p += "?a=view";
	            c += " view";
            }
...
function file(path){
	...
	if("|eac3|mp3|wav|ogg|m4a|".indexOf(`|${ext}|`) >= 0){
